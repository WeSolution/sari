...
namespace Recursos_Financieros.Clases
{
    public class DocumentoPDF
    {
        ...
        public DocumentoPDF(string s) { cadena = s; }
        //Crea el archivo con extencion .PDF con las especificaciones necesarias
        public  Document Generar_doc(string contenido, string error)
        {
        ...
        public  string contenido_doc(int mes, string mes_nom, int año)
        {
            ...
            Contenido += "</tr>";
            ConsultarBD bd = new ConsultarBD(cadena);
        ...
        public  string vista_prev(int mes, string mes_nom, int año)
        {
