...
namespace Recursos_Materiales.Clases
{
    ...
    {
        //private string cadcon = @"Data Source=HP-17;Initial Catalog=SARI;Integrated Security=True";
        //private string cadcon = @"Data Source = sari.servehttp.com; Initial Catalog = SARI; user= Server; pwd=F46987DE89;";
        private string cadcon = @"Initial Catalog = sari;Persist Security Info=False; Data Source=localhost;Integrated Security=True";
