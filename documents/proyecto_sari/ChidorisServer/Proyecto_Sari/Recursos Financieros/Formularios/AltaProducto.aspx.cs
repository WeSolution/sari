...
namespace Recursos_Financieros.AltaProducto
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlConnection conexion = Conexion.Conexion.conectar_bd();
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!Page.IsValid)
                    return;
                AccesoLogica producto = new AccesoLogica();
                ...
                else
                {
                    ...
                    mensaje = "<script> window.alert('" + resultado + ".')</script>";
                    Response.Write(mensaje);
                    if (resultado > 0)
                    ...
                    producto = null;
                    AccesoLogica.InsertSuministra(Convert.ToInt32(Proveedor.SelectedValue));
                    producto = null;
                    Response.Write(mensaje);
            ...
            {
                mensaje = "<script> window.alert('Verifique que los campos esten llenados correctamente.')</script>";
                Response.Write(mensaje);
                txtNombre.Text = txtMarca.Text = txtModelo.Text = txtDescripcion.Text = txtPrecioCompra.Text = "";
                txtCantidad.Text = txtNombreProveedor.Text = txtTelefono1.Text = "";
                txtTelefono2.Text = txtCiudad.Text = txtDireccion.Text = "";
