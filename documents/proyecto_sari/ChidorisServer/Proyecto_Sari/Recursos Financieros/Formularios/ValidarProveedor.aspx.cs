...
namespace Recursos_Financieros.Formularios
{
    public partial class ValidarProveedor : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable td = Clases.estandar.consulta_proveedor();
        ...
        protected void btnbuscar_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = Clases.estandar.consulta_proveedor_todo(Convert.ToInt32(cmbproveedor.Value));
            ...
            DataTable dt2 = Clases.estandar.consulta_producto_suministra(Convert.ToInt32(cmbproveedor.Value));
            //se pasan los datos que tiene el datatable a un GridView y se hace el enlace de datos con el DataBind()
            ...
            DataTable dt3 = Clases.estandar.consulta_servicio_brinda(Convert.ToInt32(cmbproveedor.Value));
            //se pasan los datos que tiene el datatable a un GridView y se hace el enlace de datos con el DataBind()
