<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Principal.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Recursos_Materiales.MasterPage.Default" %>
...
<div class="jumbotron">
  ...
  <div class="row">
      <div class="col-md-4">
          <img class="img-responsive" src="../Imágenes/in.png" height="80" width="80" align="center" />
        <br />
      ...
      <div class="col-md-4">
          <img class="img-responsive" src="../Imágenes/out.png" height="80" width="80" align="center"  />
        <br />
      ...
      <div class="col-md-4">
          <img class="img-responsive" src="../Imágenes/new.png" height="80" width="80" align="center"  />
        <br />
