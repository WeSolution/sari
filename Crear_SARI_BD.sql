...
go
--Crear Tabla Persona--
create table Persona (idpersona int primary key identity (1,1), nombre varchar (60) NOT NULL, apaterno varchar (30) NOT NULL,amaterno varchar (30) NOT NULL, curp varchar (18) unique NOT NULL, rfc varchar (15) unique, fechanac date,sexo varchar(15),estadocivil varchar(15),estatus varchar(15), fkdireccion int null, foreign key (fkdireccion) references Direccion (iddireccion));
go
