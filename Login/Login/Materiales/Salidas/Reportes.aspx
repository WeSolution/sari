<%@ Page Title="" Language="C#" MasterPageFile="~/Materiales/Salidas/Salidas.master" EnableEventValidation="false"   AutoEventWireup="true" CodeBehind="Reportes.aspx.cs" Inherits="Recursos_Materiales.Salidas.Reportes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Contenedor" runat="server">
    <form>
<div class="container">
<h1 class="page-header">Reporte de Salidas</h1>
