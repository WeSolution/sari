...
namespace Recursos_Financieros.Formularios
{
    ...
    {
        private Clases.estandar es = new Clases.estandar(System.Configuration.ConfigurationManager.ConnectionStrings[1].ToString());
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataTable dtproveedor = es.consulta_proveedor();
        ...
        protected void btnbuscarprov_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = new DataTable();
            // se asigna el valor devuelto por el metodo consulta_servicio el cual regresa un datatable
            dt = es.consulta_datos_prove(Convert.ToInt32(cmbproveedor.Value));
        ...
        protected void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            es.insert_servicio(txtidentificador.Text, txtnombre.Text, txtdescripcion.Text, Convert.ToDouble(txtprecio.Text));
            ...
            es.insert_atiende(Convert.ToInt32(cmbproveedor.Value));
        }
