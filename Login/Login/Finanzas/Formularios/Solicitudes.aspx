<%@ Page Title="" Language="C#" MasterPageFile="~/Finanzas/Principal.Master" AutoEventWireup="true" CodeBehind="Solicitudes.aspx.cs" Inherits="Recursos_Financieros.Formularios.Solicitudes" %>
            ...
            $.ajax({
                ...
                success: function (data){
                    ...
                    $contenido_html = "<h3>Caracteristicas:<p>" + data.d[1] + "</p></h3>" +
                                       ...
                                       "<input id='prueba' onclick='aceptar(" + data.d[0] + ");' style='padding:15px; position: relative; left: 5%;' type='submit' value='Aceptar'>" +
...
<body>
    ...
    <div style="padding-left:5%; padding-bottom:-50px;"  >
        <table style="box-shadow:0px 10px 10px rgba(0,0,0,0.5);" border="2px" class="table table-bordered table-hover table-condensed"  cellpadding="0" cellspacing="0">
            <tr>
            ...
            <tr>
                ...
                <td  rowspan="7" style="position:absolute; border:2px; height:412px; width:435px;">
                    <div class="contenedor" style="overflow:scroll; height:412px; width:640px;">
                    </div>
                </td>
            </tr>
